...
public class Variables {
    public static void main(String[] args) {
        ...
        // Sans casse
        System.out.println(chaine.equalsIgnoreCase(pi));
        ...
        String s2 = s.substring(0, 5);    // "Hello" (l'index de début est inclus, l'index de fin est exclus.)
        System.out.println("s1 = " + s1 + " s2 = " + s2);
        
        // Comparaison (< 0 si c1 < c2, > 0 si c1 > c2, 0 si c1 = c2)
        // Alphabetiquement pour les string, la casse compte)
        String c1 = "apple";
        String c2 = "banana";
        int res = c1.compareTo(c2);  // < 0 car "apple" < "banana"
        
        // format permet de formater une chaine de caractere.
        // %s pour les string, %d pour int, %f pour float, %t pour date/time
        String f = String.format("comparaison de %s et %s : resultat = %d", c1, c2, res);
